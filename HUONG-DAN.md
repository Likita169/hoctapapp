...
tách thành 26 file nhỏ trong thư mục `js/`, mỗi file phụ trách đúng 1 phần
...
| `26-nhap-de-tu-file.js` | Đọc file Word (.docx) đề kiểm tra, tự nhận diện câu hỏi + đáp án |
...
Equation (phân số, căn, số mũ...) — hiện lại **đúng dạng công thức** (KaTeX
vẽ lại, giống hệt cách app đã hiển thị công thức toán từ trước), không phải
chuyển thành chữ thường như "5π/12":
